...
Public Class report_gajii
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.report gajii.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedreport_gajii
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As report_gajii = New report_gajii()
        rpt.Site = Me.Site
        Return rpt
    End Function
